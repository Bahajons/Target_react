  ...
  render() {
    return (
      <div>
        ...
        <div className="tis">
          {/* <!-- Asosiy rasm --> */}
          <img src="images/trening.jpg" alt="Target international school" />
          <div className="container">
            <div className="w-75 mx-auto">
              <h4 className="pt-3">Biznes trening
                <br /><span>haqida</span>
              </h4>
            </div>
            <p><span className="px-md-5 px-3"></span>Target brendi asoschisi Begzod Jalilov tomonidan <b>"O'quv markaz
              ochish va uni to'g'ri boshqarish"</b> mavzusida Biznes treningi bo'lib. Bu treningda o'quv markaz
              ochish biznesdagi dastlabki ko'nikmalarni shakllantirish
              qo'rquvni yengish, o'quv markaz faoliyatidagi moliyaviy bilimlarni o'rni va bu moliyaviy bilimlar
              o'rgatiladi.
            </p>
          </div>
          {/* <!-- Line --> */}
          <div className="line">
            <div className="container">
              <div className="py-md-3 py-2 d-flex justify-content-center align-items-center my-auto">
                ...
                <a href="https://www.youtube.com/c/TargetEdu/playlists" className="mx-4 d-flex justify-content-center align-items-center"><i
          ...
          <div className="photos">
            <div className="container">
              ...
              <div className="row">
                <div className="col-sm-4 col-6 py-md-3 py-2"><img src="images/136.jpg" alt="" /></div>
                <div className="col-sm-4 col-6 py-md-3 py-2"><img src="images/132.jpg" alt="" /></div>
                <div className="col-sm-4 col-6 py-md-3 py-2"><img src="images/114.jpg" alt="" /></div>
                <div className="col-sm-4 col-6 py-md-3 py-2"><img src="images/135.jpg" alt="" /></div>
                <div className="col-sm-4 col-6 py-md-3 py-2"><img src="images/142.jpg" alt="" /></div>
                <div className="col-sm-4 col-6 py-md-3 py-2"><img src="images/148.jpg" alt="" /></div>
              </div>
            </div>
          </div>
            ...
            <div className="container">
              ...
              <div className="row">
                <div className="col-lg-4 col-md-6 col-sm-12 py-2">
                  <div className="">
                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/2Lcs4x0iM1U"
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 py-2">
                  <div className="">
                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/8GFVn8PDfAg"
                      title="YouTube video player" frameborder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                      allowfullscreen></iframe>
                  </div>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 py-2">
                  <div className="">
                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/k9JVf5UoAOQ"
                      title="YouTube video player" frameborder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                      allowfullscreen></iframe>
                  </div>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 py-2">
                  <div className="">
                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/gTGZuqOgKQY"
                      title="YouTube video player" frameborder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                      allowfullscreen></iframe>
                  </div>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 py-2">
                  <div className="">
                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/40EzwAeSi2U"
                      title="YouTube video player" frameborder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                      allowfullscreen></iframe>
                  </div>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 py-2">
                  <div className="">
                    <iframe title="https://www.youtube.com/embed/M-27jtI6CoM" width="100%" height="100%"
                      src="https://www.youtube.com/embed/M-27jtI6CoM" frameborder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                      allowfullscreen=""></iframe>
                  </div>
                </div>
