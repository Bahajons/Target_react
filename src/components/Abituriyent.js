...
export default class Abituriyent extends Component {
  componentDidMount() {
    window.scrollTo(0, 0)
  }
  render() {
    return (
      <div>
        ...
        <div>
          <div className="tis">
            {/* <!-- Asosiy rasm --> */}
            <img src="images/abituriyent.png" alt="Target international school" />
            <div className="container">
              <div className="w-75 mx-auto">
                <h4 className="pt-3">Abituriyent 3.0 loyihasi<br /><span>haqida</span></h4>
              </div>
              <p><span className="px-md-5 px-3"></span>Abituriyent 3.0 loyihasi o'quvchilarni chet el Oliy o'quv yurtlariga yoki ularning filiallariga tayyorlovchi Amerika va Finlandiya o'quv metodikasiga asoslangan loyiha hisoblanadi. Ushbu loyiha Ingliz tili, Metematika, Mental arifmetika, tanqidiy fikrlash, Arab tili fanlarini o'z ichiga oladi. Asosan loyiha yoshlarni kelajakda lider bo'lishi uchun Target brendi asoschisi Bekhzod Jalilov tomonidan Biznes treyning o'tib kelinadi.<br />

                Alohida ta'kidlash joizki, o'qishga qiziqishi yo'q o'quvchilarni ham biz chetda qoldirmaymiz ya'ni loyiha ichiga kirgan motivatsion treyninglar hamda Piramida oromgohiga bepul sayohat o'quvchilarning bilimga bo'lgan ishtiyoqini yanada oshiradi. Ko'pchilik abituriyentlarni qiynab keladigan kontrakt muammosi ham ushbu loyiha bilan ancha yengillashadi.
                Fanlarni yaxshi o'zlashtirib oliy o'quv yurtiga kirgandan so'ng, kasbiy ta'lim o'rgatilinadi.<br />

                Bu orqali o'quvchilar yaxshi maosh topa olishi hamda o'z kontraktini o'zi to'lay olishi mumkin.  Abituriyent 3.0 loyihasi o'quvchilar uchun 15ta GRANT ajratgan.</p>
            </div>
            {/* <!-- Line --> */}
            <div className="line">
              <div className="container">
                <div className="py-md-3 py-2 d-flex justify-content-center align-items-center my-auto">
                  ...
                  <a href="https://www.youtube.com/watch?v=v5eLFDKJJJ8&list=PLrrYV9PYxLcc0jWVFPjm8rPKXNR1zLrZ1" className="mx-4 d-flex justify-content-center align-items-center"><i
                ...
                <div className="row">
                  ...
                  <div className="col-lg-4 col-md-6 col-sm-12 left">
                    <div>
                      ...
                      <p>
                        Ingliz tili fani loyihadagi asosiy fan hisoblanadi.<br />Yuqorida ta'kidlanganidek, Target o'quv markazi yoshlarni chet el O'quv yurtlariga tayyorlaydi. Chet el o'quv yurtlariga kirish imtihonlari ingliz tilida olib boriladi.
                  ...
                  <div className="col-lg-4 col-md-6 col-sm-12 left">
                    <div>
                      ...
                      <p>
                        Mnemonika hotirani kuchaytiruvchi yangi fan hisoblanadi va hozrida ushbu fan bo'yicha dunyo bo'yicha keng qamrovli Olimpiyadalar o'tkzilib kelinmoqda. Ushbu fanni o'rgangan o'quvchi so'zlarni tez yodlay oladi, o'rgatilgan bilimlar esda qolishini ta'minlab
                        beradi.
                      </p>
                    </div>
                  </div>
            ...
            <div className="photos">
              <div className="container">
                ...
                <div className="row">
                  ...
                  <div className="col-sm-4 col-6 py-md-3 py-2"><img src="images/147.jpg" alt="" /></div>
                  <div className="col-sm-4 col-6 py-md-3 py-2"><img src="images/04.jpg" alt="" /></div>
                  <div className="col-sm-4 col-6 py-md-3 py-2"><img src="images/129.jpg" alt="" /></div>
                  <div className="col-sm-4 col-6 py-md-3 py-2"><img src="images/128.jpg" alt="" /></div>
                  <div className="col-sm-4 col-6 py-md-3 py-2"><img src="images/15.jpg" alt="" /></div>
                </div>
              </div>
            </div>
              ...
              <div className="container">
                ...
                <div className="row">
                  <div className="col-lg-4 col-md-6 col-sm-12 py-2">
                    <div className="">
                      <iframe width="100%" height="100%" src="https://www.youtube.com/embed/e5FRuYcDonc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                  </div>
                  <div className="col-lg-4 col-md-6 col-sm-12 py-2">
                    <div className="">
                      <iframe width="100%" height="100%" src="https://www.youtube.com/embed/v5eLFDKJJJ8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                  </div>
                  <div className="col-lg-4 col-md-6 col-sm-12 py-2">
                    <div className="">
                      <iframe width="100%" height="100%" src="https://www.youtube.com/embed/v3LE7JD8YwU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                  </div>
                  <div className="col-lg-4 col-md-6 col-sm-12 py-2">
                    <div className="">

                      <iframe width="100%" height="100%" src="https://www.youtube.com/embed/tTUdDSxu-W4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                  </div>
                  <div className="col-lg-4 col-md-6 col-sm-12 py-2">
                    <div className="">
                      <iframe width="100%" height="100%" src="https://www.youtube.com/embed/P8oP3tOqlWo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                  </div>
                  <div className="col-lg-4 col-md-6 col-sm-12 py-2">
                    <div className="">
                ...
                >
                  ...
                  <div className="item">
                    <div className="card w-100">
                      ...
                      <h5 className="text-center py-1">Bahrom Mamajonov</h5>
                  ...
                  <div className="item">
                    <div className="card w-100">
                      ...
                      <p className="text-center">Mental arifmetik</p>
                    </div>
                  </div>
                  <div className="item">
                    <div className="card w-100">
            ...
            {/* <!-- Ro'yxatdan o'tish --> */}
            <div className="registr pb-0" style={{ height: '500px' }}>
              <div className="container">
              ...
              <div className="container">
                <div className="row">
                  ...
                  <div className="col-md-3 col-6 offset-md-0 my-3 d-flex flex-column col3">
                    ...
                    <Link className="pb-3" to="international">Target international school
                    </Link>
